      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            ...
            text="Architecting high-converting responsive web interfaces with React, TypeScript, Next.js, and modern CSS for enterprise clients."
          ...
          <TagCard
            ...
            text="Engineering enterprise backends, high-throughput microservices, and secure database schemas with Java, Spring Boot, PostgreSQL, and Redis."
